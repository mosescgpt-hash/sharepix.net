 ...
 * __tests__/analytics-function-copy.test.ts. This copy is the one that
 * decides what may be stored: the browser can send any string it likes, and
 * only names in here become rows.
 */
