/**
 * The Lambda's copy of the Successful Event rules.
 *
 ...
 * lib/successfulEvent.ts and __tests__/successful-event-function-copy.ts fails
 * if it drifts. If you change one, re-copy it over the other.
 *
 * This copy is the one that actually decides anything: create-event-photo uses
 * `contributorKey` to work out whether an upload came from someone this event
 * has not seen before. The app-side copy only reports what this one counted.
 */
