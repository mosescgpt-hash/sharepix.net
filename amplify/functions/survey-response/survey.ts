 ...
 * __tests__/survey-function-copy.test.ts. The page validates as a courtesy to
 * the host, and this copy is the fence: every answer stored has been through
 * cleanAnswers here, whatever the browser sent.
 */
