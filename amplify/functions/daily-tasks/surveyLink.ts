/**
 * The Lambda's copy of the survey link encoding.
 *
 * Byte-identical to lib/surveyLink.ts below the header; the drift guard is in
 * __tests__/research-incentive.test.ts. The page encodes nothing — it only
 * passes the string through — so this copy is what actually reads a link.
 */
