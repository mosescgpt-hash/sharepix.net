  ...
  return (
    <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
      ...
      <div className="flex flex-col rounded-2xl border border-ink/10 bg-white p-6">
        ...
        <p className="mt-2">
          <span className="font-display text-4xl font-bold">${CORPORATE_PLAN.price}</span>
        ...
        <Link
          href="/corporate"
          className="mt-6 rounded-full border border-ink/20 py-2.5 text-center font-medium hover:border-accent hover:text-accent"
        >
          Choose {CORPORATE_PLAN.name}
        </Link>
      </div>
    </div>
  );
